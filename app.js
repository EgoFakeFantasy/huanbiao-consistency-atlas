...
const references = {
  ...
  wilsonerdos: ['Wilson 2019 · DOI', 'https://doi.org/10.1017/jsl.2018.76'],
  gitmanwelch: ['Gitman–Welch 2011 · 原文', 'https://victoriagitman.github.io/files/ramseylikecardinalsii.pdf'],
  rowbottom: ['Rowbottom 1971 · DOI', 'https://doi.org/10.1016/0003-4843(71)90009-X'],
  kleinberg: ['Kleinberg 1973 · DOI', 'https://doi.org/10.2307/2273038'],
  mitchellramsey: ['Mitchell 1979 · DOI', 'https://doi.org/10.2307/2273732'],
  mitchelljonsson: ['Mitchell 1999 · DOI', 'https://doi.org/10.48550/arXiv.math/9706207'],
  rinotjonsson: ['Rinot 2026 · DOI', 'https://doi.org/10.1007/s40574-025-00525-z'],
  apterkoepke: ['Apter–Koepke 2006 · DOI', 'https://doi.org/10.1007/s00153-006-0005-3'],
  jacksonjonsson: ['Jackson 等 2014 · DOI', 'https://doi.org/10.1017/jsl.2014.49'],
  jechweak: ['Jech《Set Theory》· 作者公开稿', 'https://euclid.colorado.edu/~monkd/jech.pdf'],
  schindlerremarkable: ['Schindler 1999 · DOI', 'https://doi.org/10.48550/arXiv.math/9909043']
};

Object.assign(papers, {
  weakcompactforms: {title:'弱紧致的三种刻画',kind:'同一个基数上的等价刻画',people:'Hanf、Scott 等 · 1960 年代；Thomas Jech（教科书整理）',story:'对不可数基数 κ，弱紧致可由“κ 不可达且每棵 κ-树有共尾分支”、Π¹₁-不可描述性，或 Lκ,κ 的适当紧致性来刻画。这里是同一性质的不同表述；ℵ₂ 的树性质则只是另一个等一致理论。',sources:[references.jechweak]},
  ineffableforms: {title:'不可言喻基数与驻集齐性',kind:'强于弱紧致的分割性质',people:'J. Baumgartner 等 · 1970 年代；Ralf Schindler · 1999',story:'对 κ 上每条序列 ⟨Aα⊆α:α<κ⟩，存在 A⊆κ，使 {α<κ:A∩α=Aα} 为驻集。这一齐性要求强于弱紧致；Schindler 把 remarkable 基数放在不可言喻与 ω-Erdős 之间。',sources:[references.jechweak,references.schindlerremarkable]},
  remarkableabs: {title:'remarkable 基数与 L(ℝ) 绝对性',kind:'已证等一致；限于适当迫使',people:'Ralf Schindler · 1999',story:'Schindler 引入 remarkable 基数，证明它的存在与 L(ℝ) 在 proper forcing 下的绝对性等一致，并指出此绝对性不推出 Π¹₁ 决定性。此处 remarkable 与 Wilson 使用的“弱 remarkable 且非 Σ₂-反射”是不同断言。',sources:[references.schindlerremarkable,references.wilsonerdos]},
  sharpembedding: {title:'L 的非平凡初等自嵌入',kind:'与 0♯ 存在等价',people:'Kenneth Kunen；Thomas Jech《Set Theory》第 18 章整理',story:'0♯ 给出 L 的 Silver 不可辨元；移动这些不可辨元可构造非平凡初等嵌入 j:L→L。反向由这种嵌入重建不可辨元并得到 0♯。这里的定义域与陪域都是 L，不是 V→V。Jech 的引理 18.31 与定理 18.45 分别证明两个方向。',sources:[references.jechweak]},
  sharpnotl: {title:'0♯ 反驳 V=L',kind:'直接蕴含；V≠L 并非 0♯ 的等价公理',people:'Jack Silver · 1960 年代；Thomas Jech《Set Theory》第 18 章整理',story:'0♯ 是编码 L 的不可辨元理论的实数，并不属于 L。因此 ZFC+“0♯ 存在”证明 V≠L。逆向不成立：V≠L 本身不要求存在 0♯，不能把 ZFC+V≠L 与本档放入同一个等一致框。',sources:[references.jechweak]},
  omegaerdos: {title:'ω-Erdős 与可迭代基数',kind:'强于弱紧致存在断言；与另一公理等一致',people:'Victoria Gitman、Philip D. Welch · 2011；Trevor M. Wilson · 2019',story:'ω-Erdős 基数的有限元组分割性质给出不可辨元。Gitman–Welch 证明：它蕴含对每个固定 n，“存在真类多个 n-可迭代基数”理论的相容性。Wilson 证明“存在非 Σ₂-反射的弱 remarkable 基数”与“存在 ω-Erdős 基数”等一致。最小 ω-Erdős 基数本身不必弱紧致。',sources:[references.gitmanwelch,references.wilsonerdos]},
  erdossharp: {title:'ω₁-Erdős 推出 0♯',kind:'单向蕴含；不宣称与 0♯ 等一致',people:'Frederick Rowbottom、Jack Silver · 1970—1971',story:'把 Erdős 分割性质的齐性集长度提高到 ω₁，可取得 L 的不可辨元并得到 0♯。仅有 ω-Erdős 基数可与 V=L 共存，不能把 ω 与 ω₁ 两种参数合并。',sources:[references.rowbottom,references.mitchellcover]},
  jonssonrowbottom: {title:'Jónsson、Rowbottom、Ramsey 的等一致性',kind:'三种“存在某个基数”断言等一致；同一个基数未必等价',people:'Eugene M. Kleinberg · 1973；William J. Mitchell · 1979、1999',story:'同一基数上的性质有 Ramsey ⇒ Rowbottom ⇒ Jónsson。Kleinberg 把 Rowbottom 与 Jónsson 的存在断言配到同一一致性强度；Mitchell 利用核心模型把 Jónsson 的存在与 Ramsey 的存在配对。不能据此把单个奇异 Jónsson 基数说成 Ramsey。',sources:[references.kleinberg,references.mitchellramsey,references.mitchelljonsson]},
  jonssonreflection: {title:'Jónsson 基数与驻集反射',kind:'直接推论及仍待解决的指定基数问题',people:'Tryba、W. Hugh Woodin；Assaf Rinot · 2026 年综述',story:'Jónsson 基数 κ 的每个驻集都反射，因此正则基数的后继不可能是 Jónsson。奇异基数的后继能否成为 Jónsson 仍是公开问题；这比“存在某个 Jónsson 基数”强得多。',sources:[references.rinotjonsson]},
  rowbottomalephomega: {title:'ℵω 的 Rowbottom 性质',kind:'ZFC 中仍未解决；无选择版本有精确等一致性',people:'Arthur W. Apter、Peter Koepke · 2006',story:'ZFC+“ℵω 为 Rowbottom 基数”是否相容，论文列为长期开放问题。若移到 ZF+¬AC 并加入固定 n 的 DCℵₙ 与 Rowbottom 滤子，Apter–Koepke 证明其与“ZFC+存在可测基数”等一致。基础理论与滤子条件不能省略。',sources:[references.apterkoepke]},
  adjonsson: {title:'AD 模型中的 Jónsson 与 Rowbottom 性质',kind:'ZF+AD+V=L(ℝ) 背景下的直接结论',people:'Steve Jackson、Richard Ketchersid、Farmer Schlutzenberg、W. Hugh Woodin · 2014',story:'在 ZF+AD+V=L(ℝ) 中，每个小于 Θ 的不可数基数都是 Jónsson；若其共尾度为 ω，则进一步是 Rowbottom。这个无选择结论不等于 ZFC 中 ℵω 为 Rowbottom 的相容性问题已解决。',sources:[references.jacksonjonsson]},
...
const tiers = [
  ...
  {name:'弱紧致—Ramsey 基数',code:'TIER 04',summary:'从弱紧致、不可言喻、remarkable 和 Erdős 参数层到 Jónsson／Rowbottom／Ramsey 的等一致组；分清同一基数上的蕴含与存在断言的强度。',route:'弱紧致 → 不可言喻 → remarkable → ω-Erdős ⇢ 0♯ → ω₁-Erdős ⇢ Jónsson／Rowbottom／Ramsey',relations:[['已证等一致','存在弱紧致基数 ≡Con ℵ₂ 具有树性质',references.mitchell],['已证等价','0♯ 存在 ⇔ L 有非平凡初等自嵌入；且 0♯ ⇒ V≠L',references.jechweak],['已证等一致','存在 remarkable ≡Con L(ℝ) 在 proper forcing 下的绝对性',references.schindlerremarkable],['已证等一致','存在 Jónsson ≡Con 存在 Rowbottom ≡Con 存在 Ramsey',references.mitchellramsey],['同一基数','Ramsey ⇒ Rowbottom ⇒ Jónsson；反向不能由等一致性推出',references.kleinberg],['Erdős 参数','ω-Erdős 可与 V=L 共存；ω₁-Erdős ⇒ 0♯ 存在',references.rowbottom],['开放问题','奇异基数的后继能否为 Jónsson？ZFC 下 ℵω 能否为 Rowbottom？',references.rinotjonsson]],bands:[
    {label:'弱紧致层',theories:[['ZFC + 存在弱紧致基数','κ 的树性质／Π¹₁-不可描述性'],['ZFC + ℵ₂ 具有树性质','Mitchell–Silver 等一致性'],['ZFC + 必然 c.c.c. 极大性原则','Hamkins–Woodin 等一致性']],reason:'对同一 κ，弱紧致亦可由无 κ-Aronszajn 树及适当的无穷逻辑紧致性刻画；ℵ₂ 树性质只是等一致而非同一基数等价。',sources:[references.jechweak,references.mitchell,references.hamkins],problems:['tp','weakcompactforms']},
    {label:'不可言喻（ineffable）层',theories:[['ZFC + 存在不可言喻基数','每条 κ-序列有驻集上的相干猜测']],reason:'驻集齐性要求强于弱紧致；这是一档独立的存在断言，不与相邻档合并为等一致。',sources:[references.jechweak,references.schindlerremarkable],problems:['ineffableforms'],link:'solid'},
    {label:'remarkable 层',theories:[['ZFC + 存在 remarkable 基数','Schindler 的大基数'],['ZFC + L(ℝ) 在 proper forcing 下绝对','精确限定迫使类别']],reason:'Schindler 证明这两种存在断言等一致，并把其强度定位在不可言喻与 ω-Erdős 之间。',sources:[references.schindlerremarkable],problems:['remarkableabs'],link:'solid'},
    {label:'ω-Erdős 层',theories:[['ZFC + 存在 ω-Erdős 基数','κ → (ω)₂^{<ω}'],['ZFC + 存在非 Σ₂-反射的弱 remarkable 基数','Wilson 的等一致性结果']],reason:'ω-Erdős 在存在断言上严格强于弱紧致；它可与 V=L 共存，故不推出 0♯。最小 ω-Erdős 基数本身不必弱紧致。',sources:[references.gitmanwelch,references.wilsonerdos],problems:['omegaerdos'],link:'solid'},
    {label:'0♯ 层',theories:[['ZFC + 0♯ 存在','L 的不可辨元'],['ZFC + 存在非平凡初等嵌入 j:L→L','Kunen 的等价刻画'],['ZFC + 无参数解析决定性 Π¹₁-Det','Martin–Harrington 定理']],reason:'0♯ 与 L 的非平凡初等自嵌入等价，并直接反驳 V=L；单独的 V≠L 弱得多。解析决定性是细体、无实参数的配对。0♯ 可在 L 中给出每个可数 α 的 α-Erdős 基数；¬SCH 必有 0♯，但其精确强度更高。与上一框的连接线不主张已核对的严格强度。',sources:[references.jechweak,references.harrington,references.larson,references.mitchellcover],problems:['sharpembedding','sharpnotl','analytic','schsharp'],link:'dashed'},
    {label:'ω₁-Erdős 层',theories:[['ZFC + 存在 ω₁-Erdős 基数','κ → (ω₁)₂^{<ω}']],reason:'把齐性集长度提高到 ω₁ 即推出 0♯；反向与严格强度差距在图中不作断言。',sources:[references.rowbottom],problems:['erdossharp'],link:'implication'},
    {label:'Jónsson / Rowbottom / Ramsey 层',theories:[['ZFC + 存在 Jónsson 基数','等基数的真初等等子结构'],['ZFC + 存在 Rowbottom 基数','有限元组分割的准齐性'],['ZFC + 存在 Ramsey 基数','所有有限元组同时齐性']],reason:'三种存在断言等一致（Kleinberg、Mitchell）。同一个基数满足 Ramsey ⇒ Rowbottom ⇒ Jónsson；Jónsson 可为奇异基数，故不能反向认作 Ramsey。指定 ℵω 为 Rowbottom 时，强度问题完全不同。',sources:[references.kleinberg,references.mitchellramsey,references.mitchelljonsson,references.apterkoepke],problems:['jonssonrowbottom','jonssonreflection','rowbottomalephomega','adjonsson'],link:'dashed'}
  ],note:'Erdős 的 α 是齐性集的序型，ω 与 ω₁ 不可混为一档。ℵω 的 Rowbottom 性质在 ZFC 中仍未解决；ZF+¬AC+DCℵₙ 加 Rowbottom 滤子的版本与可测基数等一致，详见弹窗。'},
